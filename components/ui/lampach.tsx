...
import { SparklesCore } from "./sparkkles";
  ...
  return (
    ...
    <LampContainer >
      <motion.h1
        ...
        className="mt-8 bg-gradient-to-br from-blue-300 to-orange-500 py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl"
      >
        Achievements <br /> 
      </motion.h1>
      <motion.div
  ...
  return (
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        <div className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-orange-300 opacity-50 blur-3xl"></div>
        <motion.div
          initial={{ width: "8rem" }}
        ...
        <motion.div
          ...
          className="absolute inset-auto z-50 h-0.5 w-[30rem] -translate-y-[7rem] bg-orange-200 "
        ></motion.div>
