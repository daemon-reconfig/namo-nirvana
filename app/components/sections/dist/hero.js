        ...
        React.createElement("div", { className: "text-center" },
            React.createElement("div", { className: "max-w-md mx-auto" },
                ...
                React.createElement("div", { className: "relative w-full" },
                    React.createElement("div", { className: "absolute inset-x-4 top-0 bg-gradient-to-r from-transparent via-indigo-500 to-transparent h-1 w-2/3 blur-sm" }),
                    React.createElement("div", { className: "absolute inset-x-4 top-0 bg-gradient-to-r from-transparent via-indigo-500 to-transparent h-px w-2/3" }),
                    React.createElement("div", { className: "absolute inset-x-12 top-0 bg-gradient-to-r from-transparent via-sky-500 to-transparent h-2 w-1/3 blur-sm" }),
                    React.createElement("div", { className: "absolute inset-x-12 top-0 bg-gradient-to-r from-transparent via-sky-500 to-transparent h-px w-1/3" }),
                    ...
                    React.createElement("div", { className: "absolute inset-0 w-full h-full bg-black opacity-50" })),
